...
import { TypographySmall } from "./UI/Typography/Small.tsx";
...
// biome-ignore lint/complexity/noStaticOnlyClass: because it's a utility class
class ColorUtils {
...
`,
      ...
      >
        ...
        <TypographySmall>{initials}</TypographySmall>
      </AvatarFallback>
    </Avatar>
  );
};
